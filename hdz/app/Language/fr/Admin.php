...
return [
    'login' => [
        ...
        'lockedMinutes' => 'Connexion verrouillée pour %minutes% minutes',
        'attemptNumber' => '(tentative:: %attempt1% de %attempt2%)',
    ...
    'tickets' => [
        'menu' => 'Tickets',
        'showingResults' => 'Affichage %x% de %y% à %z%',
        'totalReplies' => '%number% reponses',
        'id' => 'Ticket ID',
